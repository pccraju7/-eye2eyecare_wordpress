		...
		<table cellspacing="0" cellpadding="0" style="width:100%;font-size:12px !important;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;"><u><b>Financial Policy</b></u></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 5px; font-family: Arial, Helvetica, sans-serif;">All co-pays and payments are due at the time of service. Fees paid for eye examination, contact lens evaluation, medical
services, purchase of glasses and/or contact lenses are to be made in FULL on the day of purchase and are <b>non-refundable.</b></p>
	...
	<tr style="background-color: #fff; text-align: center;">
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;"><u><b>Appointments</b></u></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 5px; font-family: Arial, Helvetica, sans-serif;">Please help us better serve you and other patients by keeping your scheduled appointments. We require you to call, email,
...
"Appointments and Cancellations Policy" for more information.</p>   
				</td>
			</tr>
			</tbody>
		</table>
	...
	<tr style="background-color: #fff; text-align: center;">
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;"><u><b>Glasses</b></u></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 5px; font-family: Arial, Helvetica, sans-serif;">All orders for glasses are FINAL. After your exam, you can return to the office within 60 days at no charge for a re-check
with the doctor if you are experiencing any problems such as blurred vision, headaches, or any other discomfort. <b>After 60 days, there is a $50 fee.</b></p>   
	 ...
	 <tr style=" background-color: #fff; text-align: center;">
		...
		<table cellspacing="0" cellpadding="0" style=" width:100%;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;"><b><u>Manufacturer Warranty on Glasses and/or Lenses</u></b></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 0px; font-family: Arial, Helvetica, sans-serif;">Frames and Premium lenses that have a manufacturer's warranty can be replaced one time within one year of purchase upon approval from the manufacturer for defects. <b>A handling fee of $25 for will apply per frame or pair of lenses replaced. Some restrictions apply.</b>
					</p>
				</td>
			</tr>
			</tbody>
	 ...
	 <tr style="background-color: #fff; text-align: center;">
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;"><u><b>Contact Lenses</b></u></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 5px; font-family: Arial, Helvetica, sans-serif;">All orders for contact lenses are <b>FINAL</b>. All contact lens follow-up visits or finalization of contact lens prescriptions must
be done within 30 days of the Contact Lens Exam, unless otherwise instructed by the doctor. <b>After 30 days, there is a $30 fee.</b></p>   
				</td>
			</tr>
			</tbody>
		</table>
	...
	<tr style="background-color: #fff; text-align: center;">
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;">
			...
			<tr style="width: 100%;">
				<td style="text-align: left; width: 100%; padding: 1px 5px;">
					<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;text-align: center;"><u><b>HIPAA Privacy Acknowledgement of Notice of Privacy Practices</b></u></h1>
					<p style="font-size: 11px; margin-top: 5px; margin-bottom: 0px; font-family: Arial, Helvetica, sans-serif;">I understand, acknowledge, and agree that I have received a copy of the Notice of Privacy Practices for review and to keep
...
<tr style="font-family: Arial, Helvetica, sans-serif;">
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;">
			<tbody style="width: 100%;">
				<tr style=" width: 100%;">
					<td colspan="3">
						<h1 style=" margin-bottom:10px; font-size:20px;  margin-top: 10px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;padding-left:5px;">The following person (s) may have access to information in my records:</h1>
					</td>
				</tr>
				<tr style=" width: 100%;">
				...
				<table style=' width:100%;' cellspacing='0' cellpadding='0'>
					...
					<tr><td>&nbsp;</td></tr>
                     <tr style=' width: 100%;'>
                         <td colspan='2' style='padding: 1px 5px; font-size: 11px;'>
                             <b>
                              By signing below, I hereby state that I have read, understood, and will abide by the above office policies.
							  </b>
							  <br/><br/>
					...
					<tr style=' width: 100%;margin-top:11px;margin-bottom:1px;'>
						<td style='padding: 0px; font-size: 11px; width:50%; text-align: center;'>	
							<img src='<?php echo $fileurl2;?>' height='100px'><br/>
                            <label for='seasonal_allergies_name' style='font-weight: 600; font-size: 13px;'>
								Signature of patient (or parent/guardian if minor)
                            </label>
						</td>
		...
		<table cellspacing="0" cellpadding="0" style="width:100%;font-size:12px !important;">
			...
			<tr style="width: 100%;">
				<td style="padding: 5px; font-size: 14px; width: 100%;text-align:center;">
					<img src='<?php echo $logoimg ;?>' width='150px' height='150px' style='align:center;'>													
				</td>
			</tr>
			</tbody>
		</table>
	...
	<tr style="background-color: #fff; text-align: center;">
		<td>
			<table cellspacing="0" cellpadding="0" style="width:100%;">
				...
				<tr style="width: 100%;">
					<td style="text-align: left; width: 100%; padding: 1px 5px;">
						<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;text-align: center;">Appointments and Cancellations Policy</h1>
						<p style="font-size: 11px; margin-top: 5px; margin-bottom: 0px; font-family: Arial, Helvetica, sans-serif;">Thank you for trusting us with your Eyecare. When you schedule an appointment, we set aside time specifically for us to
	...
	<tr style="background-color: #fff; text-align: center;">
		<td>
			<table cellspacing="0" cellpadding="0" style="width:100%;">
				...
				<tr style="width: 100%;">
					<td style="text-align: left; width: 100%; padding: 1px 5px;">
						<h1 style=" margin-bottom:0px; font-size:20px;  margin-top: 0px; color:#000; padding: 0px;  font-family: Times New Roman, Times, serif;text-align: center;">Please carefully review our Appointment Cancellations and No-Show policy below.</h1>
						<p style="font-size: 11px; margin-top: 5px; margin-bottom: 0px; font-family: Arial, Helvetica, sans-serif;">We, at Eye to Eyecare, understand that sometimes you may need to cancel or reschedule your appointment. However,
...
<b><a href="mailto:Contact@EyeToEyecareTX.com">Contact@EyeToEyecareTX.com</a>.</b>
	...
	<tr style="width: 100%;">
		<td style="text-align: left; width: 100%; padding: 1px 5px;">Thank you for your understanding of our policies.
		</td>
	</tr>
	<tr style='font-family: Arial, Helvetica, sans-serif;'>
				<td>
...
Cancellations Policy.</b><br /> <br />							  
                         </td>
                    </tr>
					<tr style=' width: 100%;margin-top:11px;margin-bottom:1px;'>
						<td style='padding: 0px; font-size: 11px; width:50%; text-align: center;'>	
							<img src='<?php echo $fileurl3 ;?>' height='100px'><br/>
                            <label for='seasonal_allergies_name' style='font-weight: 600; font-size: 13px;'>
