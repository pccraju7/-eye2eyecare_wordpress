...
<table width='100%'  bgcolor='#fff' align='center' cellspacing='0' cellpadding='0' style='border:2px solid #000;'><tbody>
	...
	<tr class="border_bottom" >
		...
		<tr >
	     ...
	     <tr style='background-color: #c0c0c0; text-align: center;' class="border_bottom border_top ">
				<td>
				...
				<table style=' width:100%;' cellspacing='0' cellpadding='0'>
					...
					<tr style=' width: 100%;margin-top:11px;margin-bottom:1px;'>
						<td style='padding: 0px; font-size: 11px; width:50%; text-align: center;'>	
							<img src='<?php echo $fileurl ;?>' height='100px'><br/>
					...
					<tbody style="width: 100%;">
						...
						<tr style="width: 100%;">
							<td style="text-align: left; width: 100%; padding: 1px 5px;">
								<h1
									style="margin-bottom: 0px; font-size: 20px; margin-top: 0px; color: #000; padding: 0px; font-family: Times New Roman, Times, serif;">
							...
							<td style="text-align: left; width: 100%; padding: 1px 5px;">
								...
								<p
									...
									rescheduled. <b>At the Office's discretion, "No-Shows" to
										...
										Cancellations Policy" for more information.
						...
						<tr style="width: 100%;">
							<td style="text-align: left; width: 100%; padding: 1px 5px;">
								...
								<p
									...
									return to the office within 60 days at no charge for a re-check
									with the doctor if you are experiencing any problems such as
									blurred vision, headaches, or any other discomfort. <b>After 60
										days, there is a $50 fee.</b>
								</p>
							</td>
						</tr>
					</tbody>
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tbody style="width: 100%;">
						...
						<tr style="width: 100%;">
							<td style="text-align: left; width: 100%; padding: 1px 5px;">
								<h1
									style="margin-bottom: 0px; font-size: 20px; margin-top: 0px; color: #000; padding: 0px; font-family: Times New Roman, Times, serif; text-align: center;">
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tbody style="width: 100%;">
						<tr style="width: 100%;">
							<td colspan="3">
								<h1
									style="margin-bottom: 10px; font-size: 20px; margin-top: 10px; color: #000; padding: 0px; font-family: Times New Roman, Times, serif; padding-left: 5px;">The
			...
			<td>
				<table style='width: 100%;' cellspacing='0' cellpadding='0'>
					<tbody style='width: 100%;'>
						...
						<tr style='width: 100%;'>
							<td colspan='2' style='padding: 1px 5px; font-size: 11px;'><b> By
									signing below, I hereby state that I have read, understood, and
									will abide by the above office policies. </b> <br />
							<br /></td>
						</tr>
						<tr style='width: 100%; margin-top: 11px; margin-bottom: 1px;'>
							<td
								style='padding: 0px; font-size: 11px; width: 50%; text-align: center;'>
								<img src='<?php echo $fileurl2;?>' height='100px'><br /> <label
			...
			<td>
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						<td style="text-align: center; width: 100%;">
							<h1
								style="margin: 20px 0 15px 0; font-size: 24px; color: #000; font-family: Times New Roman, Times, serif;">EYE
								TO EYECARE OFFICE POLICY</h1>
						</td>
					</tr>
				</table>
	...
	<table width="100%" bgcolor="#fff" align="center" cellspacing="0"
		...
		<tr>
			<td style="text-align: left; padding: 5px;">
				<h1
					style="font-size: 18px; color: #000; font-family: Times New Roman, Times, serif;">Payment
					and Financial Policy</h1>
				<ul style="font-size: 12px; margin: 5px 0; padding-left: 20px;">
					<li>All payments, including co-pays, are due on the day of your
						visit.</li>
					<li>This includes fees for exams, contact lens evaluations/exams,
						glasses, and medical services.</li>
					<li>Payments are <b>non-refundable</b> and must be paid <b>in full</b>
						at the time of service or purchase.
					</li>
					<li><b>If you have insurance, it's important that you let us know
							before your appointment.</b> We can't send a claim to your
						insurance company if we don't have that information ahead of time.
						Some charges may be billed to your insurance, but you (the
						patient) may still be responsible for certain costs.</li>
					<li>By signing below, you agree that you are responsible for paying
						all charges, even if your insurance doesn’t cover them.</li>
				</ul>

				<h1
					style="font-size: 18px; color: #000; font-family: Times New Roman, Times, serif;">Glasses
					Policy</h1>
				<ul style="font-size: 12px; margin: 5px 0; padding-left: 20px;">
					<li><b>All glasses orders are final and non-refundable.</b></li>
					<li>If you’re having issues (blurry vision, headaches, discomfort),
						you can come in for a <b>free recheck within 60 days of your exam.</b>
					</li>
				...
				<h1
					...
					Warranty</h1>
				<ul style="font-size: 12px; margin: 5px 0; padding-left: 20px;">
					<li>Frames/lenses with warranty may be replaced <b>once within 1
							year</b>, if approved.
					</li>
					<li><b>A $25 handling fee</b> applies per replacement.</li>
					<li>Some restrictions apply.</li>
				</ul>

				<h1
					style="font-size: 18px; color: #000; font-family: Times New Roman, Times, serif;">Privacy
					Policy (HIPAA)</h1>
				<ul style="font-size: 12px; margin: 5px 0; padding-left: 20px;">
					<li>I understand and received a copy of the <b>Notice of Privacy
							Practices</b>.
					</li>
		...
		<tr>
			<td style="padding: 5px;">
				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000;">People
					who can access my medical records</h1>
				<table cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td style="padding: 5px; width: 33.33%;"><label
							style="font-size: 12px;">Name 1:</label><br /> <input type="text"
							value="<?php if(isset($_POST['AccessFirstName1'])){echo $_POST['AccessFirstName1']; }?>"
							style="width: 95%; border: 0; border-bottom: 1px solid #000;"></td>
						<td style="padding: 5px; width: 33.33%;"><label
							style="font-size: 12px;">Relationship:</label><br /> <input
							type="text"
							value="<?php if(isset($_POST['AccessRelation1'])){echo $_POST['AccessRelation1']; }?>"
							style="width: 90%; border: 0; border-bottom: 1px solid #000;"></td>
						<td style="padding: 5px; width: 33.33%;"><label
							style="font-size: 12px;">Phone:</label><br /> <input type="text"
							value="<?php if(isset($_POST['AccessPhone1'])){echo $_POST['AccessPhone1']; }?>"
							style="width: 85%; border: 0; border-bottom: 1px solid #000;"></td>
					</tr>
					<tr>
						<td style="padding: 5px;"><label style="font-size: 12px;">Name 2:</label><br />
							<input type="text"
							value="<?php if(isset($_POST['AccessFirstName2'])){echo $_POST['AccessFirstName2']; }?>"
							style="width: 95%; border: 0; border-bottom: 1px solid #000;"></td>
						<td style="padding: 5px;"><label style="font-size: 12px;">Relationship:</label><br />
							<input type="text"
							value="<?php if(isset($_POST['AccessRelation2'])){echo $_POST['AccessRelation2']; }?>"
							style="width: 90%; border: 0; border-bottom: 1px solid #000;"></td>
						<td style="padding: 5px;"><label style="font-size: 12px;">Phone:</label><br />
							<input type="text"
							value="<?php if(isset($_POST['AccessPhone2'])){echo $_POST['AccessPhone2']; }?>"
							style="width: 85%; border: 0; border-bottom: 1px solid #000;"></td>
					</tr>
		...
		<tr>
			<td style="padding: 5px; font-size: 12px;">
				<div style="margin-bottom: 15px;">
					<span style="display: inline-block; margin-bottom: 7px;"> Can we
						leave detailed messages with them? </span><br> <label
						style="margin-right: 15px;"> <input type="radio" name="messages"
						value="Yes"
						<?php if ((isset($_POST['Is_Message']) && ($_POST['Is_Message'] == "1" || $_POST['Is_Message'] == "Yes"))) { echo 'checked'; } ?>>
						Yes
					</label> <label> <input type="radio" name="messages" value="No"
						<?php if ((isset($_POST['Is_Message']) && ($_POST['Is_Message'] == "2" || $_POST['Is_Message'] == "No"))) { echo 'checked'; } ?>>
						No
					</label>
				</div>
			</td>
		...
		<tr>
			<td style="padding: 5px; font-size: 12px;">
				<div style="margin-top: 10px;">
					...
					<span style="display: inline-block; margin-bottom: 7px;"> Can we
						give them prescriptions or contact lenses? </span><br> <label
						style="margin-right: 15px;"> <input type="radio"
						name="prescriptions" value="Yes"
						<?php if ((isset($_POST['Is_Message2']) && ($_POST['Is_Message2'] == "1" || $_POST['Is_Message2'] == "Yes"))) { echo 'checked'; } ?>>
						Yes
					</label> <label> <input type="radio" name="prescriptions"
						value="No"
						<?php if ((isset($_POST['Is_Message2']) && ($_POST['Is_Message2'] == "2" || $_POST['Is_Message2'] == "No"))) { echo 'checked'; } ?>>
						No
					</label>
				</div>
			</td>
		...
		<tr>
			<td style="padding: 10px 5px;">
				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000;">Acknowledgment</h1>
				<p style="font-size: 12px; margin: 5px 0;">By signing below, I agree
					that I have read, understood, and accept the above office and
					privacy policies.</p>
				<table cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td style="width: 50%; text-align: center;"><img
							src="<?php echo $fileurl4;?>" alt="Signature Image"
							height="100px"><br /> <label
							style="font-weight: 600; font-size: 12px;">Patient or Legal
								Representative Signature</label></td>
						<td style="width: 50%; text-align: center;"><input type="text"
							value="<?php echo date('m/d/Y'); ?>" readonly
							style="border: 0; border-bottom: 1px solid #000; font-weight: 600; text-align: center; width: 60%;"><br />
							<label style="font-size: 12px;">DATE</label></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						<td style="text-align: center; width: 100%;">
							<h1
								style="margin: 20px 0 15px 0; font-size: 24px; color: #000; font-family: Times New Roman, Times, serif;">
								EYE TO EYECARE – APPOINTMENTS &AMP; CANCELLATIONS POLICY</h1>
						</td>
					</tr>
				</table>
			</td>
	...
	<table width="100%" bgcolor="#fff" align="center" cellspacing="0"
		...
		<tr>
			<td style="padding: 5px;">
				<p style="font-size: 12px; margin: 5px 0;">Thank you for choosing
					Eye to Eyecare. When you book an appointment with us, we reserve
					that time just for you so we can give you the best care possible.</p>
				<p style="font-size: 12px; margin: 5px 0;">We understand that
					sometimes plans change. If you need to cancel or reschedule, please
					let us know as soon as possible.</p>

				<h1
					style="font-size: 18px; margin: 10px 0 5px 0; font-family: Times New Roman, Times, serif; color: #000;">
					Our Policy:</h1>
				<ul style="font-size: 12px; margin: 5px 0 10px 20px; padding: 0;">
					<li style="margin-bottom: 8px;"><b>Cancel at least 24 hours before
							your appointment.</b><br /> This helps us offer that spot to
						another patient who may be waiting.</li>
					<li style="margin-bottom: 8px;"><b>If you do not cancel in time and
							don't show up</b>, it will count as a <b>"No‑Show"</b>.<br /> You
						may be charged a <b>$25 No‑Show Fee</b> per missed appointment.<br />
						<em>(Fee may vary at the office's discretion.)</em></li>
					<li style="margin-bottom: 8px;"><b>If you reschedule too many times</b>,
						even with notice, we may place you on <b>"Walk‑In Only"</b>
						status.<br /> You may still be charged a No-Show fee in these
						cases.</li>
				</ul>
				...
				<p style="font-size: 12px; margin: 5px 0;">You can cancel or
					reschedule your appointment by:</p>
				...
				<h1
					style="font-size: 18px; margin: 10px 0 5px 0; font-family: Times New Roman, Times, serif; color: #000;">
					Acknowledgment:</h1>
				<p style="font-size: 12px; margin: 5px 0;">By signing below, I
					confirm that I have read, understood, and agree to follow this
					Appointments and Cancellations Policy.</p> <!-- Signature & Date Section -->
				<table cellspacing="0" cellpadding="0" width="100%"
					style="margin-top: 10px;">
					<tr>
						<td style="width: 50%; text-align: center; vertical-align: top;">
							<img src="<?php echo $fileurl5;?>" alt="Signature" height="100px"><br />
							<label style="font-weight: 600; font-size: 12px;"> Patient or
								Legal Representative Signature </label>
						</td>
						<td style="width: 50%; text-align: center; vertical-align: top;">
							<input type="text" value="<?php echo date('m/d/Y');?>" readonly
							style="border: 0; border-bottom: 1px solid #000; font-weight: 600; text-align: center; width: 60%;">
							<br /> <label style="font-size: 12px;">DATE</label>
						</td>
					</tr>
				</table>
			</td>
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						<td style="text-align: center; width: 100%;">
							<h1
								style="margin: 20px 0 15px 0; font-size: 24px; color: #000; font-family: Times New Roman, Times, serif;">
								Contact Lens Exam Policy</h1>
							<p
								style="font-size: 12px; font-style: italic; margin-bottom: 20px;">
								Please read carefully and complete the form below.</p>
						</td>
					</tr>
				</table>
			</td>
	...
	<table width="100%" bgcolor="#fff" align="center" cellspacing="0"
		...
		<tr>
			<td style="padding: 5px;">
				...
				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000; margin-top: 0;">
					What's Included in Today's Routine Eye Exam:</h1>
				<ul style="font-size: 12px; margin: 5px 0 10px 20px; padding: 0;">
				...
				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000; margin-top: 10px;">
					Please Note:</h1>
				<ul style="font-size: 12px; margin: 5px 0 10px 20px; padding: 0;">
					<li>This exam <b>does NOT include</b> a contact lens exam or
						prescription.
					</li>
					<li>If you want a contact lens exam or prescription, there is an <b>additional
							fee due on the day of your visit.</b></li>
				</ul>

				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000; margin-top: 10px;">
					Contact Lens Exam Fee Details:</h1>
				<ul style="font-size: 12px; margin: 5px 0 10px 20px; padding: 0;">
					<li>Fee includes follow‑up visits (if needed)</li>
					<li>If not covered by vision insurance, <b>out-of-pocket</b> fee is
						typically <b>$80 to $165</b></li>
					<li>All contact lens orders are <b>final</b>(no returns/exchanges)
					</li>
					<li>Follow-up visits or finalizing a contact lens prescription must
						be done <b>within 30 days</b> of your exam. After 30 days, a <b>$40
							follow-up fee</b> will apply.
					</li>
				...
				<h1
					...
					Please note:</h1>
				<ul style="font-size: 12px; margin: 5px 0 10px 20px; padding: 0;">
					<li>If you choose to have your contact lens evaluation/exam on a
						different day than your routine eye exam, you have up to <b>3
							months</b> to return. During this time, you will only be
						responsible for the standard outof-pocket fee, which ranges from <b>$80
							to $165, if not covered by your insurance</b>.
					</li>
					<li>If you choose to schedule your contact lens exam <b>after</b>
						the 3-month period, we will need to recheck your prescription,
						which requires an <b>additional fee of $50 on top of the regular
							contact lens exam fee.</b></li>
				</ul>

				<h1
					style="font-size: 18px; font-family: Times New Roman, Times, serif; color: #000; margin-top: 10px;">
					Please Select One:</h1>
				<table cellspacing="0" cellpadding="0" width="100%"
					style="margin-bottom: 10px;">
					<tr>
						<td style="font-size: 12px; padding: 5px;"><label> <input
								style="vertical-align: middle;" type="radio" name="contact_lens_consent"
								value="yes"
								<?php if(isset($_POST['contact_lens_consent']) && $_POST['contact_lens_consent']=="yes"){echo 'checked';} ?>>
								Yes, I understand the contact lens exam is a separate fee from
								my routine eye exam.
						</label> <br> <label> <input style="vertical-align: middle;"
								type="radio" name="contact_lens_consent" value="no"
								<?php if(isset($_POST['contact_lens_consent']) && $_POST['contact_lens_consent']=="no"){echo 'checked';} ?>>
								No, I do not want a contact lens exam
						</label></td>
					</tr>
				</table>
				...
				<h1
					...
					Acknowledgment:</h1>
				<p style="font-size: 12px; margin: 5px 0;">By signing below, I
					confirm that I have read and understand the Contact Lens Exam
					Policy and agree to the terms, including responsibility for any
					out-of-pocket costs.</p> <!-- Signature & Date -->
				<table cellspacing="0" cellpadding="0" width="100%"
					style="margin-top: 10px;">
					<tr>
						<td
							...
							<input type="text"
							value="<?php echo isset($_POST['patient_name_contact_lens']) ? htmlspecialchars($_POST['patient_name_contact_lens']) : ''; ?>"
							readonly
							style="border: 0; border-bottom: 1px solid #000; width: 60%; text-align: center; font-weight: 600;"><br>
							<label style="font-size: 12px; font-weight: 600;"> Patient Name
								(Legal Representative): </label>
						</td>
						<td
							style="width: 33.33%; text-align: center; vertical-align: top;">
							<img src="<?php echo $fileurl6;?>" alt="Signature" height="100px"><br>
							<label style="font-size: 12px; font-weight: 600;"> Signature of
								patient (or legal representative) </label>
						</td>
						<td
							style="width: 33.33%; text-align: center; vertical-align: top;">
							<input type="text" value="<?php echo date('m/d/Y');?>" readonly
							style="border: 0; border-bottom: 1px solid #000; width: 60%; text-align: center; font-weight: 600;">
							<br> <label style="font-size: 12px;">DATE</label>
						</td>
					</tr>
				</table>
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						<td style="text-align: center; width: 100%;">
							<h1
								style="margin: 20px 0 15px 0; font-size: 24px; color: #000; font-family: Times New Roman, Times, serif;">
								Advanced Retinal Screening</h1>
							<p
								style="font-size: 12px; font-style: italic; margin-bottom: 20px;">
								Please read and complete the form below.</p>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td style="padding: 5px;">
				...
				<p style="margin: 10px 0;">
					At <strong>Eye to Eyecare</strong>, we're committed to providing
					the most thorough and latest eye care available. We recommend a
					comprehensive <strong>Advanced Retinal Screening</strong>, which
					includes high-resolution retinal imaging and <strong>OCT (Optical
						Coherence Tomography)</strong>, as part of your exam today.
				</p>

				<p style="margin: 10px 0;">
					<strong>What is the Retina?</strong> Think of the retina as the
					"film" inside a camera – it's the layer at the back of your eye
					that captures light and sends visual signals to your brain so you
					can see clearly.
				</p>

				<p style="margin: 10px 0;">
					These non-invasive, painless advanced tests allow us to detect
					early signs of conditions like <strong>macular degeneration,
						glaucoma, diabetic eye disease</strong>, and other retinal or
					nerve issues – even in patients without symptoms or vision
					complaints.
				</p>

				<p style="margin: 10px 0;">They are valuable for all patients and
					provide a more complete view of your eye health beyond what a
					standard exam can show.</p>

				<h1
					style="font-size: 20px; font-family: Times New Roman, Times, serif; color: #000; margin: 10px 0;">
					Please Select One:</h1>
				<table cellspacing="0" cellpadding="0" width="100%"
					style="margin-bottom: 10px;">
					<tr>
						<td style="font-size: 11px; padding: 5px;"><label
							style="display: block; line-height: 1.8;"> <input type="radio"
								name="retinal_option" value="photo_only"
								<?php if(isset($_POST['retinal_option']) && $_POST['retinal_option']=="photo_only"){echo 'checked';} ?>
								style="vertical-align: middle; margin-right: 6px;"> Retinal
								Imaging/Photo only ($39)
						</label> <label style="display: block; line-height: 1.8;"> <input
								type="radio" name="retinal_option" value="oct_scan"
								<?php if(isset($_POST['retinal_option']) && $_POST['retinal_option']=="oct_scan"){echo 'checked';} ?>
								style="vertical-align: middle; margin-right: 6px;"> OCT Scan
								only ($40)
						</label> <label style="display: block; line-height: 1.8;"> <input
								type="radio" name="retinal_option" value="both"
								<?php if(isset($_POST['retinal_option']) && $_POST['retinal_option']=="both"){echo 'checked';} ?>
								style="vertical-align: middle; margin-right: 6px;"> Both ($65
								total)
						</label> <label style="display: block; line-height: 1.8;"> <input
								type="radio" name="retinal_option" value="none"
								<?php if(isset($_POST['retinal_option']) && $_POST['retinal_option']=="none"){echo 'checked';} ?>
								style="vertical-align: middle; margin-right: 6px;"> I do NOT
								want either test
						</label></td>
					</tr>
				</table>
				...
				<h1
					...
					Acknowledgment:</h1>
				<p style="font-size: 12px; margin: 5px 0;">By signing below, I
					understand these tests are optional and not usually covered by some
					insurance, so I am responsible for the fee(s) listed above.</p> <!-- Signature & Date -->
				<table cellspacing="0" cellpadding="0" width="100%"
					style="margin-top: 10px;">
					<tr>
						<td
							style="width: 33.33%; text-align: center; vertical-align: top;">
							<input type="text" value="<?php echo isset($_POST['retinal_patient_name']) ? htmlspecialchars($_POST['retinal_patient_name']) : ''; ?>" readonly
							style="border: 0; border-bottom: 1px solid #000; width: 60%; text-align: center; font-weight: 600;"><br>
							<label style="font-size: 12px; font-weight: 600;"> Print Name </label>
						</td>
						<td
							style="width: 33.33%; text-align: center; vertical-align: top;">
							<img src="<?php echo $fileurl7;?>" alt="Signature" height="100px"><br>
							<label style="font-size: 12px; font-weight: 600;"> Signature </label>
						</td>
						<td
							style="width: 33.33%; text-align: center; vertical-align: top;">
							<input type="text" value="<?php echo date('m/d/Y');?>" readonly
