...
jQuery(function ($) {
		...
		// Validation function for Panel 4 (Office Policy)
		...
		// Validation function for Panel 5 (Appointments Policy)
		...
		// Validation function for Panel 6 (Contact Lens Policy)
		...
		// Validation function for Panel 7 (Retinal Screening) - Final Submission
		function checkpaientform7()
		{
			...
			{
				modal.style.display = "block";
				document.getElementById("cntpart").innerHTML='Please Put Signature for Retinal Screening Form';
								...
								<table cellspacing="0" cellpadding="0" width="100%">
									<tr>
										<td style="width:50%; text-align:center;">
											...
											<input type="hidden" name="issig4" id="issig4"><br/>
					...
					<table width="100%" bgcolor="#fff" align="center" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; border:2px solid #000; padding:5px; font-size:12px !important;">
								...
								<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;">
									<tr>
										<td style="width:50%; text-align:center; vertical-align:top;">
											...
											<input type="hidden" name="issig5" id="issig5"><br>
						...
						<tr>
							<td style="text-align: center;">
								...
								<span class="btn" onclick="checkpaientform5();">NEXT</span>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
					...
					<table width="100%" bgcolor="#fff" align="center" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; border:2px solid #000; padding:5px; font-size:12px !important;">
							...
							<table cellspacing="0" cellpadding="0" width="100%" style="margin-bottom:10px;">
								<tr>
									<td style="font-size:11px; padding:5px;">
										<input type="radio" name="contact_lens_consent" value="yes"> Yes, I understand the contact lens exam is a separate fee.<br>
							...
							<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;">
								<tr>
									<td style="width:50%; text-align:center; vertical-align:top;">
										...
										<input type="hidden" name="issig6" id="issig6"><br/>
						...
						<tr>
							<td style="padding:10px 5px; text-align:center;">
								...
								<span class="btn" onclick="checkpaientform6();">NEXT</span>
							</td>
						</tr>
					</table>
				</section>
					...
					<table width="100%" bgcolor="#fff" align="center" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; border:2px solid #000; padding:5px; font-size:12px !important;">
							...
							<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;">
								<tr>
									<td style="width:50%; text-align:center; vertical-align:top;">
										...
										<input type="hidden" name="issig7" id="issig7">
										<label style="font-size:12px; font-weight:600;">
											Signature of patient (or legal representative)
										</label>
									</td>
						...
						<tr>
							<td style="padding:10px 5px; text-align:center;">
								...
								<span class="btn" onclick="checkpaientform7();">SUBMIT</span>
							</td>
						</tr>
					</table>
				</section>
